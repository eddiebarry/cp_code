...
public:
    ...
    avl_tree_dt Find_rank(long long key){
...
int main(){
    ...
    REP(i,q){
        ...
        if(c=='L'){
            ...
            int to_find = map_id[x];
            
//            cout<<to_find<<" is to find \n";
            
            int rank = bst.Find_rank(to_find);
            
            int rank2 = siz - rank-1 ;
            int ans = rank< rank2? rank: rank2;
            cout<<ans<<"\n";
        }
    }
