...
int main(){
    ...
    REP(i,t){
        ...
        REP(i,n*m){
            ...
            g.add_edge(i,get_p(u_r_x,u_r_y,m),1);
            g.add_edge(i,get_p(u_l_x,u_l_y,m),1);
            g.add_edge(i,get_p(u_r_x_1,u_r_y_1,m),1);
            g.add_edge(i,get_p(u_l_x_1,u_l_y_1,m),1);
            g.add_edge(i,get_p(l_r_x,l_r_y,m),1);
            g.add_edge(i,get_p(l_l_x,l_l_y,m),1);
            g.add_edge(i,get_p(l_r_x_1,l_r_y_1,m),1);
            g.add_edge(i,get_p(l_l_x_1,l_l_y_1,m),1);
            
        }
        
        
        int x = sI(), y = sI();
        g.Djikstra(get_p(x,y,m));
